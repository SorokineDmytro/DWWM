...
<body>
  ...
  <div class="container-fluid p-0">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="nav">
          ...
          <div class="d-flex position-relative">
            ...
            <div class="input-group">
              ...
              <?php
                if($session_username=="Visiteur") :?>
                  <a href="javascript:void()" class="nav-link text-light fs-5 mx-3 my-1 dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-user mx-2"></i><?=$session_username?></a>
                  <ul class="dropdown-menu dropdown-menu-end bg-dark border-light">
                    <li class="nav-item mx-3"><a href="index.php?url=security&action=login" class="nav-link text-light">Se connecter</a></li>
                    <li class="nav-item mx-3"><a href="index.php?url=register&action=write" class="nav-link text-light">S'inscrire</a></li>
                  </ul>
                  <?php else :?>
                    <a href="javascript:void()" class="nav-link text-light fs-5 mx-3 my-1 dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-user mx-2"></i><?=$session_username?></a>
                    <ul class="dropdown-menu dropdown-menu-end bg-dark border-light">
                    <li class="nav-item mx-3"><a href="index.php?url=security&action=logout" class="nav-link text-light">Se deconnecter</a></li>
                    <li class="nav-item mx-3"><a href="#" class="nav-link text-light">Profil</a></li>
                    <li class="nav-item mx-3"><a href="#" class="nav-link text-light">Changer le mot de passe</a></li>
                  </ul>
                <?php endif ;?>
            </div>
          </div>
    ...
    <main class="container-fluid p-0">
      <div class="row w-100">
        <aside class="col-md-2 px-0 bg-light px-auto d-print-none">
        ...
        <aside class="col-md-2 px-0 bg-light d-print-none">
    ...
    <footer class="bg-dark text-light d-flex justify-content-center align-items-center d-print-none">
  ...
  <script>
    ...
    function getMessage() {
      fetch("index.php?page=message_read")
